...
namespace OpenXmlExcel
{
    class ClsUtilitiesExcel
    {
        ...
        private static Row CreateHeaderRowForExcel() //ciò che deve apparire
        {
            Row workRow = new Row();
        ...
        private static Row GenerateRowForChildPartDetail(TestModel testmodel) //va a prendere l'oggetto dalla sua lista, la sua rappresentazione
        {
            Row tRow = new Row();
